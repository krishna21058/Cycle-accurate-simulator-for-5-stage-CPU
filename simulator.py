...
def LUI(register, immediate, reg_values):
    val = str(immediate)
    val = val + "000000000000"
    reg_values[register] = val
    
# LUI("00000", 11010101010101010101, reg_values)

def AUIPC(register, immediate, pc, reg_values):
    val = str(immediate)
    val = val + "000000000000"
    val = pc + int(val,2)
    reg_values[register] = format(val, '032b')

# AUIPC("00000", 11010101010101010101, 11010, reg_values)


def JAL(register, immediate, pc, reg_values):
    imm = "0" + str(immediate) 
    reg_values[register] = pc + 4
    new_pc = bin(pc + int(imm,2))[2:]

    return new_pc

# print(JAL("00000", 11010101010101010101, 11010, reg_values))